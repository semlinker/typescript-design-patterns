...
namespace AbstractFactoryPattern {
  export namespace Demo {
    export function show() {
      ...
      var tester1: AbstractFactoryPattern.Tester = new AbstractFactoryPattern.Tester(
        factory1
      );
      tester1.test();
      ...
      var tester2: AbstractFactoryPattern.Tester = new AbstractFactoryPattern.Tester(
        factory2
      );
      tester2.test();
    }
